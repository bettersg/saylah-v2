const { getCategories, saveCategories, getItemsByCategoryAndUser, saveSubCategory } = require("../services/category_service");
...
async function getAllCategories(req, res) {
  res.json(categories);
  return getCategories(req.userId)
}
...
async function getSubcategories(req, res) {
  ...
  // userId to be filled in by a gateway
  ...
  return getItemsByCategoryAndUser(userId, categoryId)
}
...
async function createSubCategory(req, res) {
  ...
  return saveSubCategory(req.body)
